...
subLanguage:"bash"}}]})})());hljs.registerLanguage("go",(()=>{"use strict";return e=>{const n={
...
contains:a,keywords:e,illegal:"\\S"}}})());hljs.registerLanguage("java",(()=>{"use strict"
...
begin:/^\.\.\.(?=[ ]|$)/}]}]})})());hljs.registerLanguage("javascript",(()=>{"use strict"
...
name:"TypeScript",aliases:["ts"]}),b}})());hljs.registerLanguage("nginx",(()=>{"use strict";return e=>{const n={
...
illegal:"[^\\s\\}]"}}})());hljs.registerLanguage("kotlin",(()=>{"use strict"
;var e="\\.([0-9](_*[0-9])*)",n="[0-9a-fA-F](_*[0-9a-fA-F])*",a={
className:"number",variants:[{
begin:`(\\b([0-9](_*[0-9])*)((${e})|\\.)?|(${e}))[eE][+-]?([0-9](_*[0-9])*)[fFdD]?\\b`
},{begin:`\\b([0-9](_*[0-9])*)((${e})[fFdD]?\\b|\\.([fFdD]\\b)?)`},{
...
end:"$",illegal:"\n"},o]}}})());hljs.registerLanguage("properties",(()=>{"use strict";return e=>{
